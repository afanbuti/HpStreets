...
public class DoingCommentActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setTitle(ResourceUtil.getString(R.string.info_commentdoing));
		mContext = getApplicationContext();
		SharedPreferences settings = PreferenceManager
				.getDefaultSharedPreferences(DoingCommentActivity.this);
	...
	private void uploadData(String msg, String newName) {
		...
		try {
			ref = api.makeRequest("b.ashx?op=dd", params);
		} catch (Exception e) {
			Toast.makeText(getApplicationContext(),
					ResourceUtil.getString(R.string.error_net),
					Toast.LENGTH_LONG).show();
			MobclickAgent.reportError(mContext, "DoingComment_uploadData:"
					+ e.toString());
		}
