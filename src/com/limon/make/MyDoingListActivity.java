...
import com.limon.widget.MySpecialAdapter;
 ...
 * 
 */
public class MyDoingListActivity extends BaseActivity {
	private ListView mListView = null;
	private Context mContext;
	private ProgressDialog progressDialog = null;
	private MySpecialAdapter adapter = null;
	...
	private void loadList() {
		...
		try {
			jobhp = api.getArray("b.ashx?op=pe&count=15&mid=" + userId);
	...
	class DoingListTask extends AsyncTask<String, Integer, String> {
		...
		protected void onPostExecute(String result) {
			...
			adapter = new MySpecialAdapter(mContext, lInfos,
					R.layout.myitemdoing, new String[] { "name", "message",
	...
	private void delfromDoing(String sJson) {
		...
		try {
			api.makeRequest("b.ashx?op=de&id=" + userId, params);
		} catch (Exception e) {
