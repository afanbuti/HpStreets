...
public class BlogCommentListActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// .getDefaultSharedPreferences(BlogCommentListActivity.this);
	...
	private void getLocationResult() {
		...
		try {
			jobhp = api.getArray("b.ashx?op=bd&count=15&blogid=" + blogid);
			// Log.d("getObjectByUrl:jobhp", jobhp.toString());
		} catch (Exception e) {
			MobclickAgent.reportError(mContext,
					"BlogCommentList_getLocationResult:" + e.toString());
		}
