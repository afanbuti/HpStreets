...
public class GroupThree extends ActivityGroup {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		View view = getLocalActivityManager().startActivity(
				"Three",
				new Intent(this, MyTextLocatActivity.class)
