...
public class ActionFriendContactView extends LinearLayout {
	// private int max=100;
	...
	// private View.OnClickListener onConn = null;

	public ActionFriendContactView(Context ctxt, AttributeSet attrs) {
		super(ctxt, attrs);
	...
	protected void onFinishInflate() {
		...
		btnd.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (onDecr != null) {
					onDecr.onClick(ActionFriendContactView.this);
				}
			}
		});
