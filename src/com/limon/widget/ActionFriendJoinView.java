...
public class ActionFriendJoinView extends LinearLayout {
	// private int max=100;
	...
	public ActionFriendJoinView(Context ctxt, AttributeSet attrs) {
		super(ctxt, attrs);
	...
	protected void onFinishInflate() {
		...
		btnd.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (onDecr != null) {
					onDecr.onClick(ActionFriendJoinView.this);
				}
			}
		});
